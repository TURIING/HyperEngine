...
public:
    ...
    void CopyBufferToImage(Buffer* pBuffer, Image* pImage, const Area2D &area) const;
    ...
    void TransitionImageLayout(Image* pImage, VkImageLayout newLayout, VkImageAspectFlags aspectFlags = VK_IMAGE_ASPECT_COLOR_BIT, u32 baseMipLevel = 0, u32 levelCount = 1) const;
