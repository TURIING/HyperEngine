...
public:
	PhysicalDeviceBuilder& SetInstance(const Share<Instance> &pInstance) {
		m_pInstance = pInstance;
		return *this;
	}

	PhysicalDeviceBuilder& AddExtension(const char* ext);
	[[nodiscard]] Share<PhysicalDevice> Build() const;
...
class PhysicalDevice final : public VulObject<VkPhysicalDevice> {
public:
	PhysicalDevice(const Share<Instance> &pInstance, const PhysicalDeviceCreateInfo& createInfo);
	...
	static PhysicalDeviceBuilder Builder() { return PhysicalDeviceBuilder{}; }
